...
class DataValidation:
    ...
    def validate_number_of_columns(
        ...
        try:
            ...
            logging.info(
                f"The required number of columns : "
                f"{number_of_columns}"
            )

            logging.info(
                f"Data Frame has columns : "
    ...
    def validate_numerical_columns_exist(
        self,
        dataframe: pd.DataFrame
    ) -> bool:
        ...
        try:
            ...
            numerical_columns_config = len(
                self._schema_config["numerical_columns"]
            )

            logging.info(
                f"The required numerical columns : "
                f"{numerical_columns_config}"
            )

            logging.info(
                f"Dataframe numerical columns : "
                f"{numerical_columns}"
            )
    ...
    def initiate_data_validation(
        ...
        try:
            ...
            logging.info(
                "Reading data from train and test csv"
            )
            ...
            logging.info(
                "Reading data from train and test csv completed"
            )
            ...
            logging.info(
                "Validate number of columns end"
            )
            ...
            train_numerical_status = (
                self.validate_numerical_columns_exist(
                    train_dataframe
                )
            )
            ...
            logging.info(
                "Validate number of numerical columns end"
            )
